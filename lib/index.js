...
var ContextAssembler = class {
	...
	constructor(store, config, persistence, log) {
...
function apply(ctx, config) {
	...
	const assembler = new ContextAssembler(sessions, resolved, () => optionalService(ctx, "sessionPersistence"), (message) => ctx.logger?.warn?.(message));
	assembler.warmIndex();
